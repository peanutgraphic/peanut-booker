...
class Peanut_Booker_Database {
	 ...
	 * @param array|null $format Optional format array.
	 ...
	 * @param array|null $format       Optional format array for data.
	 * @param array|null $where_format Optional format array for where.
	 * @return int|false Number of rows updated or false on failure.
	 */
	public static function update( string $table, array $data, array $where, ?array $format = null, ?array $where_format = null ): int|false {
		global $wpdb;
	 ...
	 * @param string     $table        Table name without prefix.
	 * @param array      $where        Where conditions.
	 * @param array|null $where_format Optional format array.
	 * @return int|false Number of rows deleted or false on failure.
	 */
	public static function delete( string $table, array $where, ?array $where_format = null ): int|false {
		global $wpdb;
	 ...
	 */
	public static function get_row( string $table, array $where, string $output = OBJECT ): object|array|null {
		global $wpdb;
	 ...
	 * @return array
	 */
	public static function get_results( string $table, array $where = array(), string $orderby = 'id', string $order = 'DESC', int $limit = 0, int $offset = 0, string $output = OBJECT ): array {
		global $wpdb;
	 ...
	 * @return string
	 */
	public static function generate_booking_number(): string {
		$prefix = 'PB';
		$date   = gmdate( 'Ymd' );
	 ...
	 */
	private static function migrate_external_gigs_columns(): void {
		global $wpdb;
